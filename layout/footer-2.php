   ...
   <div class="nb-form">
		...
		<span id="minimize_contact_form" class="d-none">
	    	<img src="<?=RESOURCE_URL.'images/close.png'?>" alt="close-contact-form" class="user-icon">
	    </span>	
  ...
  <!--Main Footer-->
    <footer class="main-footer style-two <?=($route == "null"?"alternate":"")?>" style="background-image:url(<?=RESOURCE_URL?>edulearn_images/slider/home2/slide3.jpg);background-attachment:fixed;">
						...
						<div class="row clearfix">
							...
							<div class="footer-column col-lg-5 col-md-6 col-sm-12">
								<div class="footer-widget links-widget">
									<h2>Popular Franchise</h2>
									<ul class="footer-list">
										<?php foreach($footerFranchiseArr as $index => $franchise){ ?>
											<li><a href="<?=SITE_URL.'franchise-detail/'.$franchise->seo_url_structure?>"><?=$franchise->center_name?></a></li>
										<?php } ?>	
										<li><a href="<?=SITE_URL?>franchise">Show More</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="footer-column col-lg-5 col-md-6 col-sm-12">
								<div class="footer-widget links-widget">
									...
									<ul class="footer-list">
										...
										<li><a href="<?=SITE_URL?>franchise">Franchise</a></li>
				...
				<div class="clearfix">
					...
					<div class="pull-right">
						<ul class="footer-nav">
							...
							<li><a href="javascript:void(0);" data-toggle="modal" data-target="#unSubscribeNewsletterModal">Unsubscribe from Newsletter</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="content-inner">
					...
					<div class="contact-info">
						...
						<ul class="list-style-one">
							...
							<li><span class="icon flaticon-timetable"></span>Mon-Sun:&nbsp;9.30am To 8.00pm</li>
						</ul>
					</div>
					<!-- Social Box -->
					<ul class="social-box">
						<li class="facebook"><a href="<?=$siteSettingArr->facebook_link?>" target="_blank" class="fab fa-facebook-f"></a></li>
						<li class="twitter"><a href="<?=$siteSettingArr->twitter_link?>" target="_blank" class="fab fa-twitter"></a></li>
						<li class="linkedin"><a href="<?=$siteSettingArr->linkdin_link?>" target="_blank" class="fab fa-linkedin-in"></a></li>
						<li class="instagram"><a href="<?=$siteSettingArr->instagram_link?>" target="_blank" class="fab fa-instagram"></a></li>
						<li class="youtube"><a href="<?=$siteSettingArr->youtube_link?>" target="_blank" class="fab fa-youtube"></a></li>
					</ul>
				</div>
			</div>
...
<?php if(in_array($route, $alterFooterAllowedPageArr)){ ?>
...
<!-- Mirrored from expert-themes.com/html/khidmat/index-2 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Dec 2019 15:57:34 GMT -->
</html>