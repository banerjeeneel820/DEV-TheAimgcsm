<?php
    $newsArr = fetchGlobalNews('main_page');  
	/*print"<pre>";
	print_r($newsArr);
	print"</pre>";*/
?>	   
	...
	<section class="faq-page-section">
		<div class="auto-container" id="page_content">
			<!-- Title Box -->
			<div class="title-box">
			...
			<ul class="accordion-box">
             <?php 
                ...
                $optional_pdf_path = USER_UPLOAD_DIR.'news/'.$news->optional_pdf;

                if(strlen($news->optional_pdf)>0 && file_exists($optional_pdf_path)) {   
                  $optional_pdf = USER_UPLOAD_URL.'faq/'.$news->optional_pdf;
                }else{
                  $optional_pdf = null;	
                }
             ?>
	...
	<section class="faq-form-section">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				<h2><span class="theme_color">Ask us any </span> Question</h2>
			</div>
                         ...
                         <div class="column col-lg-6 col-md-12 col-sm-12"> 
                            ...
                            <div class="form-group d-none" id="subject_div">
                             ...
                             <div class="form-group d-none" id="course_div">
                                 <select class="form-control course" name="course_id" id="course_id" style="border-radius:50px;height:50px;">
