...
<head>
    ...
    <!--Icheck Checkbox css -->
    <link href="<?=RESOURCE_URL?>css/plugins/iCheck/custom.css" rel="stylesheet">

    <!--Select 2 css -->
    <link href="<?=RESOURCE_URL?>css/plugins/select2/select2.min.css" rel="stylesheet">

    <!--printThis css -->
    <link href="<?=RESOURCE_URL?>css/plugins/printThis/print.min.css" rel="stylesheet">

    <!-- Toastr style -->
    <link href="<?=RESOURCE_URL?>css/plugins/toastr/toastr.min.css" rel="stylesheet">
    
    <!-- Datatable style --> 
    <link href="<?=RESOURCE_URL?>css/plugins/dataTables/datatables.min.css" rel="stylesheet">

    <!-- DatePickers css -->
    <link href="<?=RESOURCE_URL?>css/plugins/datapicker/datepicker3.css" rel="stylesheet">
    
    <!-- FooTable -->
    <link href="<?=RESOURCE_URL?>css/plugins/footable/footable.core.css" rel="stylesheet">
    
    <!-- Sweet alert Css -->
    <link href="<?=RESOURCE_URL?>css/plugins/sweetalert/sweetalert.css" rel="stylesheet">

    <!-- Fancy Lightbox Css -->
    <link href="<?=RESOURCE_URL?>css/plugins/fancybox/jquery.fancybox.min.css" rel="stylesheet">
    
    <!-- Pretty Checkbox Css -->
    <link href="<?=RESOURCE_URL?>css/plugins/pretty-checkbox/pretty-checkbox.min.css" rel="stylesheet">
               ...
               <ul class="nav metismenu" id="side-menu">
                        <li class="nav-header">
                            ...
                            <div class="dropdown profile-element">
                                <a href="<?=$_SESSION['user_profile_pic']?>" id="logo" data-fancybox="gallery" data-caption="Company Logo"> <img alt="image" class="rounded-circle" src="<?=USER_UPLOAD_URL.'others/'.$this->site_setting_data->logo?>" style="height: 48px;width: 48px;" /></a>
                ...
                <div class="col-lg-4">
                    <div class="title-action">
                        ...
                        <?php } ?>       
                         ...
                         <?php if($this->globalLibraryHandlerObj->checkUserRolePermission("update_site_setting","soft")){ ?>    
