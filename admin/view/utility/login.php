                ...
                <div class="ibox-content">
                    <form class="m-t" role="form" name="user_signin_form" method="post" id="user_signin_form" onsubmit="return false;">
                        ...
                        <div class="form-group">
                            <input type="text" name="user_email" class="form-control" placeholder="Enter your id or email" value="<?php if(isset($_COOKIE['user_email'])){echo $_COOKIE['user_email'];}?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group" id="show_hide_password">
                              <input class="form-control" type="password" name="user_pswd" id="user_pswd" placeholder="Enter your account password..." value="<?php if(isset($_COOKIE['user_pswd'])){echo $_COOKIE['user_pswd'];}?>" required>
           ...
           $.ajax({
            ...
            success:function(responseData){
                ...
                if(data.check == 'success'){
                 ...
                 toastr.options.onHidden = function() { window.location = adminUrl; }
