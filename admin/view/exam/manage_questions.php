                     ...
                     <input type="hidden" name="exam_id" id="exam_id" value="<?=$exam_id?>">
                       ...
                       <div class="form-action-btns" <?=(!empty($questions) ? '' : 'd-none')?>>
                          <div class="text-left"> 
                              ...
                              <button class="btn btn-primary btn-sm" id="create" type="submit" class="btn btn-success" data-toggle="tooltip" title="Save" data-placement="bottom"><i class="fa fa-save"></i> Save Questions</button>
                          </div>
       ...
       <script>
         ...
         function arrangeQuestionList(){
            ...
            if(questionCount>0){
                ...
                //Creating question list html
                let questionList = '<li>'+
                                      '<a href="javascript:void(0);" id="question_no_'+divIndex+'"'+
                                          'class="browse-question attempted" data-did="'+divIndex+'">'+
                                            '<text>'+divIndex+'</text>'+
                                        '</a>'+    
                                    '</li>';
                ...
                $("#question_child_list").append(questionList);  
            }    
            }else{
                $("#question_child_list").html('');
            }   
                     ...
                     if(data.check == 'success'){
                        ...
                        if(questions.length > 0){
                          ...
                          for(var i=0; i<questions.length; i++){
                            ...
                            let questionContainer = '<div id="questions-'+question['id']+'">';
                            ...
                            questionContainer += '\t\t\t\t\t\t\t\t\t\t<span class="badge badge-warning p-1"><i class="fa fa-chevron-up"></i> Toggle Question</span>\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t</a> \n';
                            questionContainer += '\t\t\t\t\t\t\t\t</div>\n';
                            questionContainer += '\t\t\t\t\t\t\t</div>\n';
                            ...
                            questionContainer += '\t\t\t\t\t\t\t\t\t<div class="col-sm-10">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t\t<div class="input-group">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t\t  <input type="text" class="form-control opt3" name="questions['+index+'][opt3]" placeholder="Enter Option Three..." value="'+question['opt3']+'">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t   </div>   \n';
                            questionContainer += '\t\t\t\t\t\t\t\t   </div>\n';
                            questionContainer += '\t\t\t\t\t\t\t\t </div>\t\t\t\t\t\t\t   \n';
                            questionContainer += '\t\t\t\t\t\t\t\t <div class="hr-line-dashed"></div>  \n';
                            ...
                            questionContainer += '\t\t\t\t\t\t\t\t\t<div class="col-sm-10">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t\t<div class="input-group">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t\t  <input type="text" class="form-control opt4" name="questions['+index+'][opt4]" placeholder="Enter Option Four..." value="'+question['opt4']+'">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t   </div>   \n';
                            questionContainer += '\t\t\t\t\t\t\t\t   </div>\n';
                            questionContainer += '\t\t\t\t\t\t\t\t </div>\t\t\t\t\t\t\t   \n';
                            questionContainer += '\t\t\t\t\t\t\t\t <div class="hr-line-dashed"></div> \n';
                            ...
                            questionContainer += '\t\t\t\t\t\t\t\t\t   </div>   \n';
                            questionContainer += '\t\t\t\t\t\t\t\t   </div>\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t<label class="col-sm-2 col-form-label text-right">Question Marks <span class="cursor-pointer dynamicQuestion" data-toggle="tooltip" data-placement="bottom" title="Enter Question Marks"><i class="fa fa-question-circle"></i></span></label>\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t<div class="col-sm-4">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t\t<div class="input-group">\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t\t  <input type="number" class="form-control marks" name="questions['+index+'][marks]" placeholder="Enter Question Marks..." value="'+question['marks']+'" required>\n';
                            questionContainer += '\t\t\t\t\t\t\t\t\t   </div>   \n';
                            questionContainer += '\t\t\t\t\t\t\t\t   </div>\n';
                            questionContainer += '\t\t\t\t\t\t\t\t </div>\t\t\t\t\t\t\t   \n';
                            questionContainer += '\t\t\t\t\t\t  </div>\n';
                            questionContainer += '\t\t\t\t\t  </div></div>\n';
         ...
         $(window).scroll(function() {
            ...
            if (window_top > div_top) {
                if (!$('.form-action-btns').is('.sticky')) {
                    $('.form-action-btns').addClass('sticky');
                }
            } else {
                $('.form-action-btns').removeClass('sticky');
            }
         });
         ...
         $(document).ready(function () {
            ...
            $(document).on('click','.clone-question',function(e){
               ...
               var targetDiv = 'question_header_'+ divIndex;
               ...
               questionContainer.find( '.marks' ).attr( 'name', 'questions[' + index + '][marks]' );
           ...
           $(document).on('click','#add_more,#add_first_question',function(e){
               e.preventDefault();
                ...
                questionContainer += '\t\t\t\t\t\t\t\t\t<div class="col-sm-10">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t\t<div class="input-group">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t\t  <input type="text" class="form-control opt3" name="questions['+index+'][opt3]" placeholder="Enter Option Three..." value="">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t   </div>   \n';
                questionContainer += '\t\t\t\t\t\t\t\t   </div>\n';
                questionContainer += '\t\t\t\t\t\t\t\t </div>\t\t\t\t\t\t\t   \n';
                questionContainer += '\t\t\t\t\t\t\t\t <div class="hr-line-dashed"></div>  \n';
                ...
                questionContainer += '\t\t\t\t\t\t\t\t\t<div class="col-sm-10">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t\t<div class="input-group">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t\t  <input type="text" class="form-control opt4" name="questions['+index+'][opt4]" placeholder="Enter Option Four..." value="">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t   </div>   \n';
                questionContainer += '\t\t\t\t\t\t\t\t   </div>\n';
                questionContainer += '\t\t\t\t\t\t\t\t </div>\t\t\t\t\t\t\t   \n';
                questionContainer += '\t\t\t\t\t\t\t\t <div class="hr-line-dashed"></div> \n';
                ...
                questionContainer += '\t\t\t\t\t\t\t\t\t<div class="col-sm-4">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t\t<div class="input-group">\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t\t  <input type="number" class="form-control markss" name="questions['+index+'][markss]" placeholder="Enter Question Marks..." value="" required>\n';
                questionContainer += '\t\t\t\t\t\t\t\t\t   </div>   \n';
                questionContainer += '\t\t\t\t\t\t\t\t   </div>\n';
                questionContainer += '\t\t\t\t\t\t\t\t </div>\t\t\t\t\t\t\t   \n';
                questionContainer += '\t\t\t\t\t\t  </div>\n';
           ...
           $(document).on('click','.remove-question',function(e){
               var divId = $(this).data('divid');
               var targetDiv = divId > 1 ? 'question_header_'+ (divId-1) : "main_question_container";
               index = index - 1;
            ...
            $(document).on('click','#browse_question_list',function(e){
               document.getElementById("question_list_div").scrollIntoView({ behavior: "smooth" });
           });    
