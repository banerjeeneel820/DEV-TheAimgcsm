     ...
     <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <?php if($stu_row_id == 'null'){ ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="alert alert-primary" role="alert">
                                      <strong>Error! No student data found to be cloned!</strong>
                                    </div>
                                </div>
                            </div> 
                        <?php } ?>     
                        ...
                        <div class="ibox-content" id="manage_student_loader">
                           <div class="sk-spinner sk-spinner-wave <?=($stu_row_id == 'null'? 'sk-loading':'')?>">
                            ...
                            <form class="needs-validation" id="clone_student_form" method="post" onsubmit="return false;" novalidate>
                              <input type="hidden" name="action" id="action" value="manageGlobalStudent">
                              <input type="hidden" name="stu_row_id" id="stu_row_id" value="null">
                              <input type="hidden" name="stu_id" id="stu_id" value="null">
                              <input type="hidden" name="action_type" id="action_type" value="clone">
                                ...
                                <?php if($statusUpdatePermission){ ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 pt-1">
                                         ...
                                         <label class="col-sm-2 col-form-label text-right">Select Action <span class="cursor-pointer" data-toggle="tooltip" data-placement="bottom" title="Choose which page you wish to view after saving this record"><i class="fa fa-question-circle"></i></span></label>
                                        <div class="col-sm-4 pt-1">
                                           <label class="checkbox-inline i-checks pl-2"> <input type="radio" value="view_students" name="select_action" required> <i></i> Student List </label>
                                           <label class="checkbox-inline i-checks pl-2"> <input type="radio" value="add_student" name="select_action" checked required> <i></i> New Create Student Form </label>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>       
                                <?php } ?>    

                                 <div class="form-group row"><label class="col-sm-2 col-form-label text-right">Student Notes <span class="cursor-pointer" data-toggle="tooltip" data-placement="bottom" title="Enter student notes if any"><i class="fa fa-question-circle"></i></span></label>
                                        <div class="col-sm-10">
       ...
       <script>
         ...
         $(document).ready(function () {
            ...
            $('.batch').select2({width: "98.5%",allowClear:true,placeholder:"Select a franchise first..."});
            ...
            $(document).on('submit', '#clone_student_form', function(event){
                event.preventDefault();
                
                var stu_row_id = $('#stu_row_id').val();
                var select_action = $('input[name="select_action"]:checked').val();
                ...
                swal({
                   title: "Are you sure?",
                   text: "You want to clone this student?",
                   type: "warning",
                  ...
                  success:function(responseData){
                     ...
                     if(data.check == 'success'){
                        ...
                        var redirect_url = SITE_URL+"?route="+select_action;
