            ...
            <div class="postDropzone" id="postDropzone">
              <div class="dropzone-file-area">
                <div class="dz-message" data-dz-message><span>
                    <h3 class='title'>Drop files here or click to upload files</h3>
                    <p class='text'> You have to upload the minumum size image file for keep the main site server clean and light. </p>
                  </span></div>
              </div>
            </div>
