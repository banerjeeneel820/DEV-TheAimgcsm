...
$viewFeedbackPermission = $this->utilityService->checkUserRolePermission("view_feedback");
...
$deletePermission = $this->utilityService->checkUserRolePermission("delete_student");

$resultUpdatePermission = $this->utilityService->checkUserRolePermission("update_result");
...
<div class="wrapper wrapper-content fadeInRight">
      ...
      <div class="ibox ">
        ...
        <div class="ibox-content content_div_loader">
          ...
          <a href="javascript:void(0);" class="btn btn-danger btn-md export_student_table_data" data-export="pdf">
            <i class="fa fa-file-pdf-o"></i> Export in PDF Format <span class="cursor-pointer pl-1" data-toggle="tooltip" data-placement="bottom" title="Export student records in pdf format based on search parameters on the search form. This is a longer process and may take time upto 1 hour based on records number present in table."><i class="fa fa-question-circle"></i></span>
          </a>

          <a href="javascript:void(0);" class="btn btn-primary btn-md mt-2 export_student_table_data" data-export="excel">
            <i class="fa fa-file-excel-o"></i> Export in CSV Format <span class="cursor-pointer pl-1" data-toggle="tooltip" data-placement="bottom" title="Export student records in excel format based on search parameters on the search form. This is a much faster process than pdf export and this is recomended."><i class="fa fa-question-circle"></i></span>
          </a>
  ...
  <?php if ($showStatusDropdown) { ?>
    ...
    <div class="row d-none" id="student_bulk_status_update_div">
      <div class="col-lg-12">
        <div class="ibox ">
          <div class="ibox-title">
            <h5>Save Bulk Student Data based on their status </h5>
            <div class="ibox-tools">
              <a class="collapse-link">
                <i class="fa fa-chevron-up"></i>
              </a>
          ...
          <div class="ibox-content content_div_loader">
            ...
            <div class="row">
              <div class="col-lg-3 m-b-xs">
                <select class="form-control-sm form-control input-s-sm inline record_status" name="bulk_record_status" id="bulk_record_status" data-placeholder="Select a Data type to proceed" required>
                  <option></option>
              ...
              <div class="col-lg-3 m-b-xs">
                <select class="form-control-sm form-control input-s-sm inline student_status" name="bulk_student_status" id="bulk_student_status" data-placeholder="Select Student Status">
                  <option></option>
              ...
              <div class="col-lg-3 m-b-xs">
                <select class="form-control-sm form-control input-s-sm inline result_status" name="bulk_result_status" id="bulk_result_status" data-placeholder="Select Student Result Type">
                  <option></option>
              ...
              <div class="col-lg-3">
                <button class="btn btn-success" type="submit" id="save_bulk_student_status"><i class="fa fa-save"></i>&nbsp;Save Bulk Student Status Data</button>
              </div>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.export_student_table_data', function(event) {
      ...
      if (record_limit > 360 && export_method == "pdf") {
        ...
        toastr.error(recordLimitErrorTxt, "Error!", {
          timeOut: 10000
        });
        return false;
      }
    ...
    //Handle change student bulk status record update
    $(document).on("click", "#save_bulk_student_status", function(e) {
      e.preventDefault();
      ...
      var record_status = $("#bulk_record_status").val();
      var student_status = $("#bulk_student_status").val();
      var result_status = $("#bulk_result_status").val();

      if (!record_status.length > 0 && !student_status.length > 0 && !result_status.length > 0) {

        var errorTxt = "Plase select a option at least from any of the three dropdown!";

        toastr.error(errorTxt, 'Error!', {
          timeOut: 3000,
          closeButton: true,
          progressBar: true
        });
      ...
      var alertText = "Status will be updated for selected student!"
      var errorText = "Status update was Failed!";
      var confirmText = "Yes, Go ahead!";
      var successText = "Status have been successfully updated for selected student!";

      var formData = {
        action: "updateStudentBulkStatus",
        row_id: ids,
        record_status: record_status,
      ...
      if (ids) {
        ...
        toastr.error('Please select at least one data!', errorText, {
          timeOut: 2000,
          closeButton: true,
          progressBar: true
        });
