...
$viewCoursePermission = $this->utilityService->checkUserRolePermission("view_course");

$viewNewsPermission = $this->utilityService->checkUserRolePermission("view_news");
$viewGalleryPermission = $this->utilityService->checkUserRolePermission("view_gallery");
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="table-responsive project-list">
                  ...
                  <table class="table table-stripped table-bordered toggle-arrow-tiny text-center footable" data-page-size="10" data-filter=#receipt_filter>
                    <thead class="cursor-pointer">
                      <tr>
                        <!--<th>ID.</th>-->
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.filter_table_data', function() {
     ...
     $(document).on('click', '#createServerBackup', function() {
        ...
        swal({
          title: "Are you sure?",
          text: "Current backup files will be removed and new backup files will be created",
          type: "warning",
