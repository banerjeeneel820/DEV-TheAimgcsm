<?php
  ...
  $createPermission = $this->permissionService->checkUserRolePermission("create_course"); 
  $updatePermission = $this->permissionService->checkUserRolePermission("update_course"); 
  $deletePermission = $this->permissionService->checkUserRolePermission("delete_course"); 
?>
