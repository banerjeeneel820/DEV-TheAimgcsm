...
function initDtTbl() {
  ...
  $("#DataTables_Table_0_wrapper").attr(
    "style",
...
$(document).on("click", ".changeVerifiedStatus", function () {
  var action = "globalVerifiedStatusUpdate";
  var row_id = $(this).data("rid");
  var type = $(this).data("type");
...
$(document).on("click", ".sendMailToUser", function (e) {
  ...
  var successText =
    page_type +
    (row_id == "all" ? "s have" : " has") +
    "  been successfully sent over mail!";
